...
//Рассылка
$this->router->screen('masssending', \App\Orchid\Screens\MassSendingScreen::class)->name('platform.masssending');

//Пользователи мессенджера
$this->router->screen('msgusers', \App\Orchid\Screens\MsgUsersScreen::class)->name('platform.msgusers');

//Дисконтные карты
$this->router->screen('discounts', \App\Orchid\Screens\DiscountsScreen::class)->name('platform.discounts');